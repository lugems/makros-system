...
import { Clock, Users, Car, ChevronRight, Hash, Sparkles, LayoutGrid } from 'lucide-react';
...
export function BookingCalendar({ bookings, onSelect }: BookingCalendarProps) {
  ...
  const bookingsForSelectedDate = React.useMemo(() => {
    if (!date) return [];
    // Convert current selected date to YYYY-MM-DD
                                        ...
                                        <div className="flex items-center gap-8">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <div className="flex flex-wrap items-center gap-4">
                                                    ...
                                                    <div className="flex items-center gap-2 text-[10px] font-mono font-black text-primary bg-primary/5 px-2 py-0.5 rounded border border-primary/10">
                                                        {vehicle?.numberPlate}
                                                    </div>
                                                </div>

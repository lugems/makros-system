  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="left" className="pr-0">
        ...
        >
          <span className="font-black uppercase tracking-tighter text-xl">Makros <span className="text-primary">System</span></span>
        </MobileLink>
            ...
            {navItems.map((item) => {
                ...
                return (
                  <MobileLink
                      ...
                      href={item.href}
                      onOpenChange={setOpen}
                      className="flex items-center uppercase text-[10px] font-black tracking-widest"
                  >
